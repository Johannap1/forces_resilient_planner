...
internal_mem = getattr(_lib,'FORCESNLPsolver_normal_internal_mem')
...
class FORCESNLPsolver_normal_mem(ctypes.Structure):
    pass
...
csolver.argtypes = ( ctypes.POINTER(FORCESNLPsolver_normal_params_ctypes), ctypes.POINTER(FORCESNLPsolver_normal_outputs_ctypes), ctypes.POINTER(FORCESNLPsolver_normal_info), ctypes.POINTER(FORCESNLPsolver_normal_mem), ctypes.POINTER(FILE))
csolver.restype = ctypes.c_int

internal_mem.argtypes = [ctypes.c_uint]
internal_mem.restype = ctypes.POINTER(FORCESNLPsolver_normal_mem)
...
a Python wrapper for a fast solver generated by FORCESPRO v6.0.1
 ...
 See also COPYING
    ...
    if sys.version_info.major == 2:
        ...
        try:
            PyFile_AsFile.restype = ctypes.POINTER(FILE)
            exitflag = _lib.FORCESNLPsolver_normal_solve( ctypes.byref(params_py), ctypes.byref(outputs_py), ctypes.byref(info_py), internal_mem(0), PyFile_AsFile(fp) , _lib.FORCESNLPsolver_normal_adtool2forces )
        ...
        try:
            if sys.platform.startswith('win'):
                exitflag = _lib.FORCESNLPsolver_normal_solve( ctypes.byref(params_py), ctypes.byref(outputs_py), ctypes.byref(info_py), internal_mem(0), None , _lib.FORCESNLPsolver_normal_adtool2forces)
            else:
                exitflag = _lib.FORCESNLPsolver_normal_solve( ctypes.byref(params_py), ctypes.byref(outputs_py), ctypes.byref(info_py), internal_mem(0), fp , _lib.FORCESNLPsolver_normal_adtool2forces)
            libc.fclose(fp)
