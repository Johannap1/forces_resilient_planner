...
extern solver_int32_default FORCESNLPsolver_normal_adtool2forces(double *x, double *y, double *l, double *p, double *f, double *nabla_f, double *c, double *nabla_c, double *h, double *nabla_h, double *hess, solver_int32_default stage, solver_int32_default iteration, solver_int32_default threadID);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
	...
	/* Call solver */
	solver_exitflag = FORCESNLPsolver_normal_solve(&params, &output, &info, mem, fp , pt2function_FORCESNLPsolver_normal);
