...
static void FORCESNLPsolver_normal_sparse2fullcopy(solver_int32_default nrow, solver_int32_default ncol, const solver_int32_default *colidx, const solver_int32_default *row, FORCESNLPsolver_normal_callback_float *data, FORCESNLPsolver_normal_float *out)
{
								 ...
								 solver_int32_default threadID   /* Id of caller thread                                */)
{
	...
	FORCESNLPsolver_normal_callback_float w[92];
	
    /* temporary storage for AD tool sparse output */
    FORCESNLPsolver_normal_callback_float this_f = (FORCESNLPsolver_normal_callback_float) 0.0;
    ...
    FORCESNLPsolver_normal_callback_float nabla_c_sparse[49];
	...
	if ((stage >= 0) && (stage < 1))
	{
		...
		if (nabla_f != NULL)
		{
			...
			FORCESNLPsolver_normal_sparse2fullcopy(nrow, ncol, colind, row, nabla_f_sparse, nabla_f);
		}
		...
		if (c != NULL)
		{
			...
			FORCESNLPsolver_normal_sparse2fullcopy(nrow, ncol, colind, row, c_sparse, c);
		}
		...
		if (nabla_c != NULL)
		{
			...
			FORCESNLPsolver_normal_sparse2fullcopy(nrow, ncol, colind, row, nabla_c_sparse, nabla_c);
		}
		...
		if (h != NULL)
		{
			...
			FORCESNLPsolver_normal_sparse2fullcopy(nrow, ncol, colind, row, h_sparse, h);
		}
		...
		if (nabla_h != NULL)
		{
			...
			FORCESNLPsolver_normal_sparse2fullcopy(nrow, ncol, colind, row, nabla_h_sparse, nabla_h);
		}
