...
% 
classdef FORCESNLPsolver_finalBuildable < coder.ExternalDependency
    ...
    methods (Static)
        ...
        function updateBuildInfo(buildInfo, cfg)
            ...
            if(~strcmp(foldername, 'interface') || ~strcmp(solvername, 'FORCESNLPsolver_final'))
                solverpath = fullfile(buildablepath, 'FORCESNLPsolver_final');
            end
            ForcesUpdateBuildInfo(buildInfo, cfg, 'FORCESNLPsolver_final', solverpath, 1, true);
        end
        ...
        function [output,exitflag,info] = forcesCallWithParams(params)
            [output,exitflag,info] = FORCESNLPsolver_finalBuildable.forcesCall(params.xinit, params.x0, params.all_parameters, params.num_of_threads);
        end

        function [output,exitflag,info] = forcesCall(xinit, x0, all_parameters, num_of_threads)
            solvername = 'FORCESNLPsolver_final';
            ...
            [output_c, exitflag_c, info_c] = FORCESNLPsolver_finalBuildable.forcesInitOutputsC();
            ...
            [output, exitflag, info] = FORCESNLPsolver_finalBuildable.forcesInitOutputsMatlab();
